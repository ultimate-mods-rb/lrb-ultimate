...
del "%~dp0\iso\LRB Ultimate.wbfs"
"%~dp0dependencies/wit/wit" copy "%~dp0\_build\wii" "%~dp0\iso\LRB Ultimate.wbfs"

echo:
if %FAILED_ARK_BUILD% neq 1 (echo:Successfully built LEGO Rock Band Ultimate files. A wbfs file has been generate in the iso folder)
